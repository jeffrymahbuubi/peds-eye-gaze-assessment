...
class EyeInput:
    ...
    def __init__(self, gaze_source, dwell_config: DwellConfig | None = None) -> None:
    ...
    def poll(self, t_ns: int) -> Pointer:
        """Return the gaze pointer (clicked is always False; dwell is separate).
        ...
        return Pointer(x=sample.x, y=sample.y, valid=sample.valid, clicked=False)
